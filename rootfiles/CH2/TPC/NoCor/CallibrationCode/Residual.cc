...
//	TFile* file = new TFile("HSBeamthroughHists.root");
//	TFile* file2 = new TFile("HSBeamthroughHistsFit.root","recreate");
	...
	tree->Branch("Par_x",&ParX);
	tree->Branch("Par_z",&ParZ);
