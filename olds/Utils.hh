...
void FillBH2AUHist(TString title, TTree* tree,int nch, TCut cut){
	TString branch = Form("bh2ua[%d]",nch);
	FillHist(title,tree,branch,cut);
}
void FillBH2ADHist(TString title, TTree* tree,int nch, TCut cut){
	TString branch = Form("bh2da[%d]",nch);
	FillHist(title,tree,branch,cut);
}
void FillBH1AUHist(TString title, TTree* tree,int nch, TCut cut){
	TString branch = Form("bh1ua[%d]",nch);
	FillHist(title,tree,branch,cut);
}
void FillBH1ADHist(TString title, TTree* tree,int nch, TCut cut){
	TString branch = Form("bh1da[%d]",nch);
	FillHist(title,tree,branch,cut);
}
void FillHTOFAUHist(TString title, TTree* tree,int nch, TCut cut){
	TString branch = Form("htofua[%d]",nch);
	FillHist(title,tree,branch,cut);
}
void FillHTOFADHist(TString title, TTree* tree,int nch, TCut cut){
	TString branch = Form("htofda[%d]",nch);
	FillHist(title,tree,branch,cut);
}
